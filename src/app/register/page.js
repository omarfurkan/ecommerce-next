...
import InpurComponent from "@/components/FormElements/InputComponent";
import SelectComponent from "@/components/FormElements/SelectComponent";
import { registraionFormControls } from "@/utils";
                            ...
                            </p>
                            {
                                isRegistered ? <button className="inline-flex w-full items-center justify-center bg-black px-6 py-4 text-lg text-white transition-all duration-200 ease-in-out focus:shadow font-medium uppercase tracking-wide">Login</button> :
                                    <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8 ">
                                        {registraionFormControls.map(controlItem => controlItem.componentType === 'input' ?
                                            <InpurComponent
                                                type={controlItem.type}
                                                placeholder={controlItem.plaaceholder}
